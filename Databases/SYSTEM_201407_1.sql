...
# Type: 系统自动备份
# Description:当前SQL文件包含了表：rc_access、rc_ad、rc_admin、rc_category、rc_link、rc_member、rc_message、rc_nav、rc_news、rc_node、rc_page、rc_product、rc_role、rc_role_user、rc_tag的结构信息，表：rc_access、rc_ad、rc_admin、rc_category、rc_link、rc_member、rc_message、rc_nav、rc_news、rc_node、rc_page、rc_product、rc_role、rc_role_user、rc_tag的数据
# Time: 2014-07-28 10:56:05
# -----------------------------------------------------------
# 当前SQL卷标：#1
# -----------------------------------------------------------
...
INSERT INTO `rc_category` VALUES ('74','0','公司新闻','n','zh-cn');
INSERT INTO `rc_category` VALUES ('71','0','笔记本','p','zh-cn');
INSERT INTO `rc_category` VALUES ('75','0','网络新闻','n','zh-cn');
INSERT INTO `rc_category` VALUES ('76','0','Company News','n','zh-en');
...
# 数据库表：rc_nav 数据信息
INSERT INTO `rc_nav` VALUES ('35','news','公司新闻','0','0','middle','','zh-cn','99','0');
