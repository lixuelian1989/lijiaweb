...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>后台管理地图-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='网站管理 > 后台地图'; ?>
...
<div class="clear"></div>
    ...
    <?php if(C('QRCODE')){ ?><div class="QRcode">移动设备访问本页：<br/><br/><img src="<?php echo ($QRcodeUrl); ?>"/></div><?php } ?>
                ...
                <div id="Right">
                    <div class="Item hr">
                        <div class="current">网站地图</div>
                    </div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        <?php if(is_array($admin_big_menu)): $k = 0; $__LIST__ = $admin_big_menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                   <td width="50"><?php echo ($vo); ?></td>
                                   <td>
                                       <?php $sub_menu=$admin_sub_menu[$key];$k=$key; ?>
                                       <?php if(is_array($sub_menu)): $i = 0; $__LIST__ = $sub_menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><span style="padding: 0 10px 0 10px;"><a href="__APP__/<?php echo ($k); ?>/<?php echo ($key); ?>"><?php echo ($sub); ?></a></span><?php endforeach; endif; else: echo "" ;endif; ?>
                                   </td>
