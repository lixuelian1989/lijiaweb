...
<head>
    ...
    <title>管理员log记录管理-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
    <?php $addCss=""; $addJs=""; $currentNav ='管理员log记录管理 >管理员log列表'; ?>
...
<div class="clear"></div>
    ...
    <?php if(C('QRCODE')){ ?><div class="QRcode">移动设备访问本页：<br/><br/><img src="<?php echo ($QRcodeUrl); ?>"/></div><?php } ?>
        ...
        <div id="Right">
            <div class="Item hr">
                <div class="current" style="max-width: 100px; float: left;">管理员log列表</div>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["l_id"]); ?>">
                        <td align="left"><?php echo ($vo["l_id"]); ?></td>
                        <td><?php echo ($vo["l_cz"]); ?></td>
                        <td><?php echo ($vo["l_name"]); ?></td>
                        <td><?php echo ($vo["admin_name"]); ?></td>
                        <td>[ <a link="<?php echo U('Siteinfo/deladminlog/',array('l_id'=>$vo['l_id']));?>" href="javascript:void(0)" name="<?php echo ($vo["l_name"]); ?>" class="del">删除 </a> ]</td>
