...
<html>
    <head>
        <meta charset="utf-8">
        <title>短信配置-系统设置-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
    <?php $addCss=""; ?>
    <?php $addJs=""; ?>
    ...
    <?php if(C('QRCODE')){ ?><div class="QRcode">移动设备访问本页：<br/><br/><img src="<?php echo ($QRcodeUrl); ?>"/></div><?php } ?>
            ...
            <div id="Right">
                <div class="contentArea">
                    <div class="Item hr">
                        <div class="current">短信配置</div>
                    </div>
                    <form action="" method="post">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                            <tr>
                                <th width="120">短信服务器：</th>
                                <td><input name="server" type="text" class="input" size="40" value="<?php echo ($site["DUANXIN"]["server"]); ?>" /> </td>
                            </tr>
                            <tr>
                                <th width="120">短信账户：</th>
                                <td><input name="account" type="text" class="input" size="40" value="<?php echo ($site["DUANXIN"]["account"]); ?>" /> 如果没有请到<a target="_blank" href="https://mp.weixin.qq.com/">这里</a>申请</td>
                            </tr>
                            <tr>
                                <th width="120">短信APIKEY：</th>
                                <td><input name="key" type="text" class="input" size="40" value="<?php echo ($site["DUANXIN"]["key"]); ?>" />   </td>
                            </tr>
