...
<div class="Head_nav_xia">
	<a href="<?php echo U('News/index');?>">84资讯  ></a> <a href="#"><?php echo ($catname); ?></a>
</div>
...
<div class="M Replacement_one">
	<h2><a href="#">亲，想了解更多资讯吗？</a></h2>
</div>

<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="Informa_list">
	<a href="<?php echo U('News/read',array('id'=>$vo[id]));?>" target="_blank" title="<?php echo ($vo["title"]); ?>"><img src="<?php echo ($vo["imgsrc"]); ?>" alt="<?php echo ($vo["title"]); ?>" width="996" height="259" /></a>
    <a href="<?php echo U('News/read',array('id'=>$vo[id]));?>" target="_blank" title="<?php echo ($vo["title"]); ?>"><?php echo (cn_substr($vo["title"],0,40)); ?></a>
    <p>
    <?php echo (cn_substr($vo["summary"],0,400)); ?>
    <a href="<?php echo U('News/read',array('id'=>$vo[id]));?>" target="_blank" title="<?php echo ($vo["title"]); ?>"><查看></a></p>
